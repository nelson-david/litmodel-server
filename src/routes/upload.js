	...
	try {
		...
		const uploadPromises = req.files.map(async (file) => {
			...
			const publicUrl = process.env.R2_PUBLIC_URL
				...
				: `https://${process.env.R2_ACCOUNT_ID}.r2.cloudflflarestorage.com/${process.env.R2_BUCKET_NAME}/${fileName}`; // Fallback, likely not public accessible without custom domain
